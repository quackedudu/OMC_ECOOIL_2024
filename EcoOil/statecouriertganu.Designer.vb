...
Partial Class statecouriertganu
    ...
    Private Sub InitializeComponent()
        ...
        Label9 = New Label()
        btnBack = New Button()
        lstStateCourierTganu = New ListBox()
        Label1 = New Label()
        Label2 = New Label()
        ...
        ' 
        ' lstStateCourierTganu
        ' 
        lstStateCourierTganu.BackColor = Color.Lime
        lstStateCourierTganu.FormattingEnabled = True
        lstStateCourierTganu.ItemHeight = 15
        lstStateCourierTganu.Location = New Point(12, 171)
        lstStateCourierTganu.Name = "lstStateCourierTganu"
        lstStateCourierTganu.Size = New Size(280, 214)
        lstStateCourierTganu.TabIndex = 78
        ' 
        ' Label1
        ' 
        ...
        Controls.Add(Label2)
        Controls.Add(Label1)
        Controls.Add(lstStateCourierTganu)
        Controls.Add(btnBack)
        Controls.Add(Label9)
        Controls.Add(PictureBox1)
        Name = "statecouriertganu"
    ...
    Friend WithEvents lstStateCourierTganu As ListBox
