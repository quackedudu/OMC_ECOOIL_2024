...
Partial Class statecourierperak
    ...
    Private Sub InitializeComponent()
        ...
        Label9 = New Label()
        btnBack = New Button()
        lstStateCourierPerak = New ListBox()
        Label1 = New Label()
        Label2 = New Label()
        ...
        ' 
        ' lstStateCourierPerak
        ' 
        lstStateCourierPerak.BackColor = Color.Lime
        lstStateCourierPerak.FormattingEnabled = True
        lstStateCourierPerak.ItemHeight = 15
        lstStateCourierPerak.Location = New Point(12, 171)
        lstStateCourierPerak.Name = "lstStateCourierPerak"
        lstStateCourierPerak.Size = New Size(280, 214)
        lstStateCourierPerak.TabIndex = 78
        ' 
        ' Label1
        ' 
        ...
        Controls.Add(Label2)
        Controls.Add(Label1)
        Controls.Add(lstStateCourierPerak)
        Controls.Add(btnBack)
        Controls.Add(Label9)
        Controls.Add(PictureBox1)
        Name = "statecourierperak"
    ...
    Friend WithEvents lstStateCourierPerak As ListBox
