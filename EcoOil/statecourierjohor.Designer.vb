...
Partial Class statecourierjohor
    ...
    Private Sub InitializeComponent()
        ...
        Label9 = New Label()
        btnBack = New Button()
        lstStateCourierJohor = New ListBox()
        Label1 = New Label()
        Label2 = New Label()
        ...
        ' 
        ' lstStateCourierJohor
        ' 
        lstStateCourierJohor.BackColor = Color.Lime
        lstStateCourierJohor.FormattingEnabled = True
        lstStateCourierJohor.ItemHeight = 15
        lstStateCourierJohor.Location = New Point(12, 171)
        lstStateCourierJohor.Name = "lstStateCourierJohor"
        lstStateCourierJohor.Size = New Size(280, 214)
        lstStateCourierJohor.TabIndex = 78
        ' 
        ' Label1
        ' 
        ...
        Controls.Add(Label2)
        Controls.Add(Label1)
        Controls.Add(lstStateCourierJohor)
        Controls.Add(btnBack)
        Controls.Add(Label9)
        Controls.Add(PictureBox1)
        Name = "statecourierjohor"
    ...
    Friend WithEvents lstStateCourierJohor As ListBox
