...
Partial Class statecourierkelantan
    ...
    Private Sub InitializeComponent()
        ...
        Label9 = New Label()
        btnBack = New Button()
        lstStateCourierKelantan = New ListBox()
        Label1 = New Label()
        Label2 = New Label()
        ...
        ' 
        ' lstStateCourierKelantan
        ' 
        lstStateCourierKelantan.BackColor = Color.Lime
        lstStateCourierKelantan.FormattingEnabled = True
        lstStateCourierKelantan.ItemHeight = 15
        lstStateCourierKelantan.Location = New Point(12, 171)
        lstStateCourierKelantan.Name = "lstStateCourierKelantan"
        lstStateCourierKelantan.Size = New Size(280, 214)
        lstStateCourierKelantan.TabIndex = 78
        ' 
        ' Label1
        ' 
        ...
        Label2.TabIndex = 80
        Label2.Text = "KELANTAN"
        ' 
        ' statecourierkelantan
        ' 
        ...
        Controls.Add(Label2)
        Controls.Add(Label1)
        Controls.Add(lstStateCourierKelantan)
        Controls.Add(btnBack)
        Controls.Add(Label9)
        Controls.Add(PictureBox1)
        Name = "statecourierkelantan"
    ...
    Friend WithEvents lstStateCourierKelantan As ListBox
