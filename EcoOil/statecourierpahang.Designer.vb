...
Partial Class statecourierpahang
    ...
    Private Sub InitializeComponent()
        ...
        Label9 = New Label()
        btnBack = New Button()
        lstStateCourierPahang = New ListBox()
        Label1 = New Label()
        Label2 = New Label()
        ...
        ' 
        ' lstStateCourierPahang
        ' 
        lstStateCourierPahang.BackColor = Color.Lime
        lstStateCourierPahang.FormattingEnabled = True
        lstStateCourierPahang.ItemHeight = 15
        lstStateCourierPahang.Location = New Point(12, 171)
        lstStateCourierPahang.Name = "lstStateCourierPahang"
        lstStateCourierPahang.Size = New Size(280, 214)
        lstStateCourierPahang.TabIndex = 78
        ' 
        ' Label1
        ' 
        ...
        Controls.Add(Label2)
        Controls.Add(Label1)
        Controls.Add(lstStateCourierPahang)
        Controls.Add(btnBack)
        Controls.Add(Label9)
        Controls.Add(PictureBox1)
        Name = "statecourierpahang"
    ...
    Friend WithEvents lstStateCourierPahang As ListBox
