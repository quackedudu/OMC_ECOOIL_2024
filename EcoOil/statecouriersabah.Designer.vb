...
Partial Class statecouriersabah
    ...
    Private Sub InitializeComponent()
        ...
        Label9 = New Label()
        btnBack = New Button()
        lstStateCourierSabah = New ListBox()
        Label1 = New Label()
        Label2 = New Label()
        ...
        ' 
        ' lstStateCourierSabah
        ' 
        lstStateCourierSabah.BackColor = Color.Lime
        lstStateCourierSabah.FormattingEnabled = True
        lstStateCourierSabah.ItemHeight = 15
        lstStateCourierSabah.Location = New Point(12, 171)
        lstStateCourierSabah.Name = "lstStateCourierSabah"
        lstStateCourierSabah.Size = New Size(280, 214)
        lstStateCourierSabah.TabIndex = 78
        ' 
        ' Label1
        ' 
        ...
        Controls.Add(Label2)
        Controls.Add(Label1)
        Controls.Add(lstStateCourierSabah)
        Controls.Add(btnBack)
        Controls.Add(Label9)
        Controls.Add(PictureBox1)
        Name = "statecouriersabah"
    ...
    Friend WithEvents lstStateCourierSabah As ListBox
