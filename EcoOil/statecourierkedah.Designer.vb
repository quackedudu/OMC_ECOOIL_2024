...
Partial Class statecourierkedah
    ...
    Private Sub InitializeComponent()
        ...
        Label9 = New Label()
        btnBack = New Button()
        lstStateCourierKedah = New ListBox()
        Label1 = New Label()
        Label2 = New Label()
        ...
        ' 
        ' lstStateCourierKedah
        ' 
        lstStateCourierKedah.BackColor = Color.Lime
        lstStateCourierKedah.FormattingEnabled = True
        lstStateCourierKedah.ItemHeight = 15
        lstStateCourierKedah.Location = New Point(12, 171)
        lstStateCourierKedah.Name = "lstStateCourierKedah"
        lstStateCourierKedah.Size = New Size(280, 214)
        lstStateCourierKedah.TabIndex = 78
        ' 
        ' Label1
        ' 
        ...
        Controls.Add(Label2)
        Controls.Add(Label1)
        Controls.Add(lstStateCourierKedah)
        Controls.Add(btnBack)
        Controls.Add(Label9)
        Controls.Add(PictureBox1)
        Name = "statecourierkedah"
    ...
    Friend WithEvents lstStateCourierKedah As ListBox
