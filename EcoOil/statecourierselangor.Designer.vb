...
Partial Class statecourierselangor
    ...
    Private Sub InitializeComponent()
        ...
        Label9 = New Label()
        btnBack = New Button()
        lstStateCourierSelangor = New ListBox()
        Label1 = New Label()
        Label2 = New Label()
        ...
        ' 
        ' lstStateCourierSelangor
        ' 
        lstStateCourierSelangor.BackColor = Color.Lime
        lstStateCourierSelangor.FormattingEnabled = True
        lstStateCourierSelangor.ItemHeight = 15
        lstStateCourierSelangor.Location = New Point(12, 171)
        lstStateCourierSelangor.Name = "lstStateCourierSelangor"
        lstStateCourierSelangor.Size = New Size(280, 214)
        lstStateCourierSelangor.TabIndex = 78
        ' 
        ' Label1
        ' 
        ...
        Label2.TabIndex = 80
        Label2.Text = "SELANGOR"
        ' 
        ' statecourierselangor
        ' 
        ...
        Controls.Add(Label2)
        Controls.Add(Label1)
        Controls.Add(lstStateCourierSelangor)
        Controls.Add(btnBack)
        Controls.Add(Label9)
        Controls.Add(PictureBox1)
        Name = "statecourierselangor"
    ...
    Friend WithEvents lstStateCourierSelangor As ListBox
