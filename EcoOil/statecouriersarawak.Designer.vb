...
Partial Class statecouriersarawak
    ...
    Private Sub InitializeComponent()
        ...
        Label9 = New Label()
        btnBack = New Button()
        lstStateCourierSarawak = New ListBox()
        Label1 = New Label()
        Label2 = New Label()
        ...
        ' 
        ' lstStateCourierSarawak
        ' 
        lstStateCourierSarawak.BackColor = Color.Lime
        lstStateCourierSarawak.FormattingEnabled = True
        lstStateCourierSarawak.ItemHeight = 15
        lstStateCourierSarawak.Location = New Point(12, 171)
        lstStateCourierSarawak.Name = "lstStateCourierSarawak"
        lstStateCourierSarawak.Size = New Size(280, 214)
        lstStateCourierSarawak.TabIndex = 78
        ' 
        ' Label1
        ' 
        ...
        Controls.Add(Label2)
        Controls.Add(Label1)
        Controls.Add(lstStateCourierSarawak)
        Controls.Add(btnBack)
        Controls.Add(Label9)
        Controls.Add(PictureBox1)
        Name = "statecouriersarawak"
    ...
    Friend WithEvents lstStateCourierSarawak As ListBox
